...
STATUS_NAMES = {
    "not_received": "\U0001f4ed \u0644\u0645 \u064a\u0633\u062a\u0644\u0645",
    "lost": "\U0001f504 \u0628\u062f\u0644 \u0641\u0627\u0642\u062f",
    "photo_mismatch": "\U0001f5bc \u0627\u0644\u0635\u0648\u0631\u0629 \u063a\u064a\u0631 \u0645\u0637\u0627\u0628\u0642\u0629",
    "data_diff": "\U0001f4cb \u0627\u062e\u062a\u0644\u0627\u0641 \u0641\u064a \u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a",
    "photo_diff": "\U0001f4f8 \u0627\u062e\u062a\u0644\u0627\u0641 \u0641\u064a \u0627\u0644\u0635\u0648\u0631\u0629",
}
...
def _card(cid, title, fields, rid=None):
    lines = [f"*\uD83C\uDFE2 {title}*"]
    lines.append(H)
    for k,v in fields: lines.append(f"{k} {v}")
    lines.append(H)
    if rid: lines.append(f"\uD83D\uDD11 \u0631\u0642\u0645 \u0627\u0644\u0637\u0644\u0628: `#{rid}`")
    return "\n".join(lines)
...
def main_menu(cid):
    ...
    mk.add(
        telebot.types.InlineKeyboardButton("\U0001f4dd \u0637\u0644\u0628 \u062c\u062f\u064a\u062f", callback_data="nm_new"),
        telebot.types.InlineKeyboardButton("\U0001f50d \u0628\u062d\u062b", callback_data="nm_search"),
        telebot.types.InlineKeyboardButton("\U0001f4cb \u0622\u062e\u0631 \u0627\u0644\u0637\u0644\u0628\u0627\u062a", callback_data="nm_history"),
        telebot.types.InlineKeyboardButton("\u270f\ufe0f \u062a\u0639\u062f\u064a\u0644 \u0648\u062d\u0630\u0641", callback_data="nm_edit"),
        telebot.types.InlineKeyboardButton("\U0001f4ca \u0625\u062d\u0635\u0627\u0626\u064a\u0627\u062a", callback_data="nm_stats"),
    )
...
def start_req(m=None):
    ...
    nusuk_bot.send_message(cid,
        f"*\U0001F6C2 \u0627\u0644\u062e\u0637\u0648\u0629 1/5 \u2014 \u062c\u0648\u0627\u0632 \u0627\u0644\u0633\u0641\u0631*\n{H}\n"
...
def get_pass(m):
    ...
    if exists:
        nusuk_bot.reply_to(m,
            ...
            f"\U0001F4CB \u0627\u0644\u062c\u0648\u0627\u0632: `{txt}`\n"
            f"\U0001F511 \u0631\u0642\u0645 \u0627\u0644\u0637\u0644\u0628: `#{exists[0]}`\n{H}\n"
            f"\u062c\u0627\u0631\u064d \u0627\u0644\u0639\u0645\u0644 \u0639\u0644\u064a\u0647 \u0641\u0639\u0644\u0627\u064b",
            parse_mode="Markdown")
    ...
    nusuk_bot.reply_to(m,
        f"*\U0001F4CC \u0627\u0644\u062e\u0637\u0648\u0629 2/5 \u2014 \u0627\u0644\u062d\u0627\u0644\u0629*\n{H}\n"
        f"\u0627\u062e\u062a\u0631 \u062d\u0627\u0644\u0629 \u0627\u0644\u0637\u0644\u0628 \u0645\u0646 \u0627\u0644\u0623\u0632\u0631\u0627\u0631:",
...
def get_status(m):
    ...
    if code not in STATUS_NAMES:
        nusuk_bot.reply_to(m, f"\u274C \u0627\u0633\u062a\u062e\u062f\u0645 \u0627\u0644\u0623\u0632\u0631\u0627\u0631 \u0641\u0642\u0637"); return
    state[cid]["status"] = code
    state[cid]["step"] = "hotel"
    nusuk_bot.reply_to(m,
        f"*\U0001F3E8 \u0627\u0644\u062e\u0637\u0648\u0629 3/5 \u2014 \u0627\u0644\u0633\u0643\u0646*\n{H}\n"
        f"\u0623\u0631\u0633\u0644 \u0627\u0633\u0645 \u0627\u0644\u0633\u0643\u0646 (\u0627\u0644\u0645\u0628\u0646\u0649):",
...
def get_hotel(m):
    ...
    if txt in ("\u0627\u0644\u063a\u0627\u0621","\u0625\u0644\u063a\u0627\u0621","cancel","\u0631\u062c\u0648\u0639","back"): del state[cid]; main_menu(cid); return
    if not txt:
        nusuk_bot.reply_to(m, f"\u274C \u064a\u0631\u062c\u0649 \u0625\u0631\u0633\u0627\u0644 \u0627\u0633\u0645 \u0627\u0644\u0633\u0643\u0646"); return
    state[cid]["hotel"] = txt; state[cid]["step"] = "floor"
    nusuk_bot.reply_to(m,
        f"*\U0001F4F6 \u0627\u0644\u062e\u0637\u0648\u0629 4/5 \u2014 \u0627\u0644\u062f\u0648\u0631*\n{H}\n"
        f"\u0623\u0631\u0633\u0644 \u0631\u0642\u0645 \u0627\u0644\u062f\u0648\u0631:",
        parse_mode="Markdown")
...
def get_floor(m):
    ...
    if txt in ("\u0627\u0644\u063a\u0627\u0621","\u0625\u0644\u063a\u0627\u0621","cancel","\u0631\u062c\u0648\u0639","back"): del state[cid]; main_menu(cid); return
    if not txt.isdigit():
        nusuk_bot.reply_to(m, f"\u274C \u064a\u0631\u062c\u0649 \u0625\u062f\u062e\u0627\u0644 \u0631\u0642\u0645 \u0635\u062d\u064a\u062d"); return
    state[cid]["floor"] = txt; state[cid]["step"] = "room"
    nusuk_bot.reply_to(m,
        f"*\U0001F6AA \u0627\u0644\u062e\u0637\u0648\u0629 5/5 \u2014 \u0627\u0644\u063a\u0631\u0641\u0629*\n{H}\n"
        f"\u0623\u0631\u0633\u0644 \u0631\u0642\u0645 \u0627\u0644\u063a\u0631\u0641\u0629:",
        parse_mode="Markdown")
...
def get_room(m):
    ...
    if txt in ("\u0627\u0644\u063a\u0627\u0621","\u0625\u0644\u063a\u0627\u0621","cancel","\u0631\u062c\u0648\u0639","back"): del state[cid]; main_menu(cid); return
    if not txt:
        nusuk_bot.reply_to(m, f"\u274C \u064a\u0631\u062c\u0649 \u0625\u0631\u0633\u0627\u0644 \u0631\u0642\u0645 \u0627\u0644\u063a\u0631\u0641\u0629"); return
    s = state[cid]
    ...
    nusuk_bot.reply_to(m,
        f"*\u2705 \u062a\u0623\u0643\u064a\u062f \u0627\u0644\u0637\u0644\u0628*\n{H}\n"
        f"\U0001F6C2 \u062c\u0648\u0627\u0632 \u0627\u0644\u0633\u0641\u0631: `{s['passport']}`\n"
        f"\U0001F4CC \u0627\u0644\u062d\u0627\u0644\u0629: {_st(s['status'])}\n"
        f"\U0001F3E8 \u0627\u0644\u0633\u0643\u0646: {s['hotel']}\n"
        f"\U0001F4F6 \u0627\u0644\u062f\u0648\u0631: {s['floor']}\n"
        f"\U0001F6AA \u0627\u0644\u063a\u0631\u0641\u0629: {s['room']}\n"
        f"\U0001F464 \u0627\u0644\u0645\u0648\u0638\u0641: {s['employee']}\n"
        f"\U0001F4C5 \u0627\u0644\u062a\u0627\u0631\u064a\u062e: {s['date']}\n{H}\n\n"
        f"\u2705 \u0623\u0631\u0633\u0644 `\u062a\u0645` \u0644\u0644\u062d\u0641\u0638\n"
...
def confirm(m):
    ...
    if txt in ("\u062a\u0645","\u062a\u0623\u0643\u064a\u062f","confirm","yes","\u0646\u0639\u0645"):
        ...
        try:
            ...
            if lcid:
                msg = (
                    f"*\U0001F4E5 \u0637\u0644\u0628 \u062c\u062f\u064a\u062f*\n{H}\n"
                    f"\U0001F6C2 \u062c\u0648\u0627\u0632: `{s['passport']}`\n"
                    f"\U0001F4CC \u0627\u0644\u062d\u0627\u0644\u0629: {_st(s['status'])}\n"
                    f"\U0001F3E8 \u0627\u0644\u0633\u0643\u0646: {s['hotel']}\n"
                    f"\U0001F4F6 \u0627\u0644\u062f\u0648\u0631: {s['floor']}\n"
                    f"\U0001F6AA \u0627\u0644\u063a\u0631\u0641\u0629: {s['room']}\n"
...
def search_menu(m=None):
    ...
    mk.add(
        telebot.types.InlineKeyboardButton("\U0001F6C2 \u0628\u062c\u0648\u0627\u0632 \u0627\u0644\u0633\u0641\u0631", callback_data="sr_pass"),
        telebot.types.InlineKeyboardButton("\U0001F3E8 \u0628\u0627\u0644\u0633\u0643\u0646", callback_data="sr_hotel"),
        telebot.types.InlineKeyboardButton("\U0001F4C5 \u0628\u0627\u0644\u062a\u0627\u0631\u064a\u062e", callback_data="sr_date"),
        telebot.types.InlineKeyboardButton("\u25C0\uFE0F \u0631\u062c\u0648\u0639", callback_data="sr_back"),
    )
    nusuk_bot.send_message(cid,
        f"*\U0001F50D \u0628\u062d\u062b \u0639\u0646 \u0637\u0644\u0628*\n{H}\n"
        f"\u0627\u062e\u062a\u0631 \u0646\u0648\u0639 \u0627\u0644\u0628\u062d\u062b:",
        parse_mode="Markdown", reply_markup=mk)
...
def cb_search(c):
    ...
    nusuk_bot.send_message(c.message.chat.id,
        f"\U0001F4E4 \u0623\u0631\u0633\u0644 \u0643\u0644\u0645\u0629 \u0627\u0644\u0628\u062d\u062b\n"
        f"_Send search term_",
        parse_mode="Markdown")
...
def do_search(m):
    ...
    if not rows:
        nusuk_bot.reply_to(m,
            f"*\u274C \u0644\u0627 \u062a\u0648\u062c\u062f \u0646\u062a\u0627\u0626\u062c*\n{H}\n"
            f"\u0644\u0645 \u064a\u062a\u0645 \u0627\u0644\u0639\u062b\u0648\u0631 \u0639\u0644\u0649 \u0637\u0644\u0628\u0627\u062a \u0645\u0637\u0627\u0628\u0642\u0629",
            parse_mode="Markdown")
        main_menu(cid); return
    lines = [f"*\U0001F50D \u0646\u062a\u0627\u0626\u062c \u0627\u0644\u0628\u062d\u062b* \u2014 {len(rows)} \u0637\u0644\u0628"]
    lines.append(H)
    for r in rows[:10]:
        ...
        lines.append("")
    if len(rows)>10:
        lines.append(f"\u2026 \u0648{len(rows)-10} \u0646\u062a\u064a\u062c\u0629 \u0623\u062e\u0631\u0649")
        lines.append(H)
...
def cmd_history(m=None):
    ...
    if not rows:
        nusuk_bot.reply_to(m,
            f"*\U0001F4ED \u0644\u0627 \u062a\u0648\u062c\u062f \u0637\u0644\u0628\u0627\u062a*\n{H}\n"
            f"\u0644\u0645 \u064a\u062a\u0645 \u062a\u0633\u062c\u064a\u0644 \u0623\u064a \u0637\u0644\u0628 \u0628\u0639\u062f",
            parse_mode="Markdown")
        return
    lines = ["*\U0001F4CB \u0622\u062e\u0631 10 \u0637\u0644\u0628\u0627\u062a*\n"]
    for r in rows:
...
def cmd_count(m=None):
    ...
    txt = f"*\U0001F4CA \u0625\u062c\u0645\u0627\u0644\u064a \u0627\u0644\u0637\u0644\u0628\u0627\u062a:* `{n}`"
...
def cmd_stats(m=None):
    ...
    if not rows:
        nusuk_bot.reply_to(m,
            f"*\U0001F4ED \u0644\u0627 \u062a\u0648\u062c\u062f \u0628\u064a\u0627\u0646\u0627\u062a*\n{H}\n"
            f"\u0644\u0645 \u064a\u062a\u0645 \u062a\u0633\u062c\u064a\u0644 \u0623\u064a \u0637\u0644\u0628\u0627\u062a \u0628\u0639\u062f",
            parse_mode="Markdown")
        return
    sts, hts = {}, {}
    for st, ho in rows: sts[st]=sts.get(st,0)+1; hts[ho]=hts.get(ho,0)+1
    lines = ["*\U0001F4CA \u0625\u062d\u0635\u0627\u0626\u064a\u0627\u062a \u0627\u0644\u0637\u0644\u0628\u0627\u062a*\n"]
    lines.append(f"*\u0627\u0644\u0639\u062f\u062f \u0627\u0644\u0643\u0644\u064a:* `{sum(sts.values())}`")
    lines.append(f"\n*\u200F\u062d\u0633\u0628 \u0627\u0644\u062d\u0627\u0644\u0629:*")
...
def edit_menu(m=None):
    cid = m.chat.id if hasattr(m,'chat') else m
    nusuk_bot.send_message(cid,
        f"*\u270F\uFE0F \u062a\u0639\u062f\u064a\u0644 \u0623\u0648 \u062d\u0630\u0641 \u0637\u0644\u0628*\n{H}\n"
        f"\u0623\u0631\u0633\u0644 \u0631\u0642\u0645 \u0627\u0644\u0637\u0644\u0628 (ID)\n"
        f"\u0645\u062b\u0627\u0644: `#1` \u0623\u0648 `1`\n{H}\n"
        f"\u0623\u0648 \u0623\u0631\u0633\u0644 `/menu` \u0644\u0644\u0631\u062c\u0648\u0639",
        parse_mode="Markdown")
...
def edit_get_id(m):
    ...
    if not txt.isdigit():
        nusuk_bot.reply_to(m, f"\u274C \u0623\u0631\u0633\u0644 \u0631\u0642\u0645 \u0635\u062d\u064a\u062d \u0645\u062b\u0627\u0644: `1`", parse_mode="Markdown")
        return
    row = _db("SELECT * FROM requests WHERE id=?", (int(txt),), fetch="one")
    if not row:
        nusuk_bot.reply_to(m,
            f"*\u274C \u0644\u0627 \u064a\u0648\u062c\u062f \u0637\u0644\u0628 \u0628\u0647\u0630\u0627 \u0627\u0644\u0631\u0642\u0645*\n{H}\n"
            f"\u062a\u0623\u0643\u062f \u0645\u0646 \u0631\u0642\u0645 \u0627\u0644\u0637\u0644\u0628 \u0648\u0623\u0639\u062f \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629",
            parse_mode="Markdown")
        return
    ...
    nusuk_bot.reply_to(m,
        f"*\U0001F511 \u0637\u0644\u0628 #{d[0]}*\n{H}\n"
        f"\U0001F6C2 \u062c\u0648\u0627\u0632: `{d[1]}`\n"
        f"\U0001F4CC \u0627\u0644\u062d\u0627\u0644\u0629: {st}\n"
        f"\U0001F3E8 \u0627\u0644\u0633\u0643\u0646: {d[3]}\n"
        f"\U0001F4F6 \u0627\u0644\u062f\u0648\u0631: {d[4]}\n"
        f"\U0001F6AA \u0627\u0644\u063a\u0631\u0641\u0629: {d[5]}\n"
        f"\U0001F464 \u0627\u0644\u0645\u0648\u0638\u0641: {d[6]}\n"
        f"\U0001F4C5 \u0627\u0644\u062a\u0627\u0631\u064a\u062e: {d[7]}\n{H}\n"
        f"\u0627\u062e\u062a\u0631 \u0625\u062c\u0631\u0627\u0621:",
        parse_mode="Markdown", reply_markup=mk)
...
def cb_edit(c):
    ...
    if action=="edit":
        ...
        mk = telebot.types.InlineKeyboardMarkup(row_width=2)
        mk.add(
            telebot.types.InlineKeyboardButton("\U0001F6C2 \u062c\u0648\u0627\u0632", callback_data=f"ef_pass_{rid}"),
            telebot.types.InlineKeyboardButton("\U0001F4CC \u062d\u0627\u0644\u0629", callback_data=f"ef_status_{rid}"),
            telebot.types.InlineKeyboardButton("\U0001F3E8 \u0633\u0643\u0646", callback_data=f"ef_hotel_{rid}"),
            telebot.types.InlineKeyboardButton("\U0001F4F6 \u062f\u0648\u0631", callback_data=f"ef_floor_{rid}"),
            telebot.types.InlineKeyboardButton("\U0001F6AA \u063a\u0631\u0641\u0629", callback_data=f"ef_room_{rid}"),
            telebot.types.InlineKeyboardButton("\u25C0\uFE0F \u0631\u062c\u0648\u0639", callback_data="ed_back"),
        )
        nusuk_bot.send_message(cid,
            f"*\u270F\uFE0F \u062a\u0639\u062f\u064a\u0644 \u0627\u0644\u0637\u0644\u0628 #{rid}*\n{H}\n"
...
def cb_edit_field(c):
    ...
    nusuk_bot.send_message(cid,
        f"*\u270F\uFE0F \u062a\u0639\u062f\u064a\u0644 {names.get(field,field)}*\n{H}\n"
...
def edit_set_value(m):
    ...
    if field=="status":
        ...
        if val not in STATUS_NAMES:
            nusuk_bot.reply_to(m,
                f"\u274C \u062d\u0627\u0644\u0629 \u063a\u064a\u0631 \u0635\u062d\u064a\u062d\u0629\n"
                f"\u0627\u0633\u062a\u062e\u062f\u0645 \u0627\u0644\u0623\u0632\u0631\u0627\u0631 \u0641\u0642\u0637")
            return
    _db(f"UPDATE requests SET {col}=? WHERE id=?", (val, rid))
    nusuk_bot.reply_to(m,
        f"*\u2705 \u062a\u0645 \u062a\u062d\u062f\u064a\u062b \u0627\u0644\u0637\u0644\u0628 #{rid}*\n{H}\n"
        f"\u062a\u0645 \u062a\u062d\u062f\u064a\u062b `{col}` \u0628\u0646\u062c\u0627\u062d",
        parse_mode="Markdown")
    ...
    try:
        ...
        def rs(m):
            room_bot.send_message(m.chat.id,
                f"*\U0001F3D4\uFE0F HAJJ ROOM \u2014 \u0646\u0638\u0627\u0645 \u0627\u0644\u063a\u0631\u0641*\n{H}\n"
